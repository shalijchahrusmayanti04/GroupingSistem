              ...
              <div class="row">
                ...
                <div class="col-6 m-auto">
                  <div class="card float-right bg-warning">
                    <div class="card-body">
                      <span class="h4 font-weight-bold text-white"><?= $header->invoice_keluar; ?></span>
                      <input type="hidden" name="inv" id="inv" value="<?= $header->invoice_keluar; ?>">
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col">
              <div class="table-responsive">
                <table class="table table-striped table-hover table-bordered" id="keluar_edit">
                  <thead>
...
<script>
  ...
  function total() {
    var table = document.getElementById('keluar_edit');
  ...
  function tambah() {
    ...
    arr.push(idrow);
    var x = document.getElementById('keluar_edit').insertRow(rowCount);
  ...
  function save() {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          url: '<?= site_url('Stok/edit_out_header/') ?>' + totalnya,
