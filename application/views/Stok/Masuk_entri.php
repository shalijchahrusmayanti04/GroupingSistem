  ...
  <div class="col">
    <div class="card">
      <div class="card-body">
        ...
        <hr>
        <form method="POST" id="f_entri_masuk">
          <div class="row">
            <div class="col">
              <div class="row">
                <div class="col-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <select name="id_supplier" id="id_supplier" class="form-control select2_supplier"></select>
                    </div>
                  </div>
                  <div class="form-group row">
          ...
          <div class="row">
            <div class="col">
              <div class="table-responsive">
                <table class="table table-striped table-hover table-bordered" id="masuk_entri">
                  <thead>
...
<script>
  ...
  function total() {
    var table = document.getElementById('masuk_entri');
  ...
  function tambah() {
    ...
    arr.push(idrow);
    var x = document.getElementById('masuk_entri').insertRow(rowCount);
  ...
  function hapus_baris(param) {
    var x = document.getElementById('masuk_entri').deleteRow(arr.indexOf(param) + 1);
  ...
  function save() {
    ...
    var totalnya = Number(parseInt(totalnyax.replaceAll(',', '')));
    ...
    if (kode_barangx != '' || kode_barangx != null && vendor != '' || vendor != null) {
      $.ajax({
        url: '<?= site_url('Stok/in_header/') ?>' + totalnya,
        data: $('#f_entri_masuk').serialize(),
        type: 'POST',
        dataType: 'JSON',
        success: function(data) {
          if (data.status == 1) {
